...
const CartContentItem: React.FC<CartContentItemProps> = ({
    ...
    return (
        <div className={`${styles.cartProduct} ${removeStatus&&styles.remove}`}>
            <div onClick={() => navigate(`products/${productTitle}`)} className={styles.cartProductImage}>
                {productTitle}
                <img src={imgURL} alt=""/>
            </div>
            <div>
            ...
            {!removeStatus?
                <div onClick={() => handleRemoveButton(productId)} className={styles.cartProductBtn}>
